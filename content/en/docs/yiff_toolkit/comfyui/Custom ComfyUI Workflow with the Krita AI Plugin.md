...
![An image showcasing how to download krita-ai-diffusion.](https://huggingface.co/rakki194/yt/resolve/main/static/comfyui/krita_ai_download.png)

## ???

Click on the workspace selection button on the top left side of the Docker.

![An image showcasing how to connect to a custom ComfyUI workflow with krita-ai-diffusion.](https://huggingface.co/rakki194/yt/resolve/main/static/comfyui/krita_ai_select_graph.png)
...
![A screenshot of ComfyUI demonstrating the Krita Output node.](https://huggingface.co/rakki194/yt/resolve/main/static/comfyui/krita_ai_output_node.png)
...
![A screenshot of ComfyUI with the Krita Canvas node connected to the Empty Latent Image and other nodes.](https://huggingface.co/rakki194/yt/resolve/main/static/comfyui/krita_ai_canvas_node.png)
